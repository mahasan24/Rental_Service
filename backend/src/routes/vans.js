...
router.get('/', async (req, res, next) => {
  try {
    const { type, minCapacity, maxPrice, sort, order } = req.query;
    ...
    const validSortCols = ['price_per_day', 'capacity', 'name'];
    const sortCol = validSortCols.includes(sort) ? sort : 'price_per_day';
